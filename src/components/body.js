      ...
      <div class="card-footer">
        ...
        <div className="container-bg " id="secondary">
          <div className="row ">
            <div
              id="skillCard"
              className="card text-white bg-dark m-5 col-lg-6  col-md-6 col-sm-6 col-xs-12"
            >
                ...
                <div className="card-text">
                  <div className="row">
                    <div className="col-12 text-right">
                      <h6>
                        Python <i className="px-1">{circle}</i>
                      ...
                      <h6>
                        Javascript<i className="px-1 my-5">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Java<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        MySQL<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        SQLServer<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        MongoDB<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        DynamoDB<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        NodeJS<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        React<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Bootstrap<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        VueJS<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Vuetify<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        ExpressJS<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        HTML<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        API's Rest<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Linux <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Github<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
                      ...
                      <h6>
                        Photoshop<i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle}</i>
                        <i className="px-1">{circle2}</i>
                        <i className="px-1">{circle2}</i>
            ...
            <div className="col text-center p-5 m-5 text-white text-center">
              ...
              <p>
                <ul className="my-0 px-0">
                  ...
                  <li>Front-End and Back-End Development with AWS Tools</li>
              ...
              <h6>
                Secretaria de Educación Publica | January 2016 - July 2016
              </h6>
              <p>
                <ul className="my-0 px-0">
          ...
          <div className="container-bg " id="primary">
            <div className="row ">
              <div className="col text-center p-5 m-5 text-white">
                ...
                <h6>
                  Instituto Tecnológico de Durango | Specialty in: Web
                  Technologies For Electronic Businesses | August 2016 - July
                  2021
                </h6>
                <p>
                  <ul className="my-0 px-0">
                    <li>Agile methodologies</li>
                    <li>Training on UI / UX and Marketing</li>
                    <li>Web Security and Social Engineering</li>
                    <li>Professional Web Development</li>
                  </ul>
                </p>
                <h4>Certifications</h4>
                <h6>June 2016 - December 2020</h6>
                <p>
                  <ul className="my-0 px-0">
                    <li>
                      CCNA Routing and Switching: Principios basicos de routing
                      y switching(CISCO)
                    </li>
                    <li>
